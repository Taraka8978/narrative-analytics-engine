      ...
      <header className="border-b border-gray-100 sticky top-0 bg-white/80 backdrop-blur-sm z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base sm:text-xl font-medium tracking-tight text-gray-900">
              Narrative Analytics <span className="text-gray-400 font-light">Engine</span>
            </h1>
          </div>
          <nav className="hidden sm:flex gap-8 text-sm font-medium text-gray-500">
          ...
          <div className="sm:hidden">
            <a href="#" className="px-3 py-1.5 border border-gray-200 rounded-lg text-xs font-bold hover:bg-gray-50 transition-all text-gray-900">Support</a>
          </div>
        </div>
      </header>
